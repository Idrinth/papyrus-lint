...
Markdown summary: one row per page with its category scores, plus a list of
the specific audits behind any score that falls under THRESHOLD.

Extracted out of lighthouse_summary.py (which mixed this logic with its CLI
