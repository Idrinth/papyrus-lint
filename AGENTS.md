...
| `.github/workflows/ci*.yml`, `.github/workflows/labels.yml`, `.github/workflows/base-scripts.yml`, or CI scripts | [`docs/agent/ci.md`](docs/agent/ci.md), [`docs/agent/base-scripts.md`](docs/agent/base-scripts.md) |
