//! Command-line interface for linting a project's `.achlist` scripts.
//!
//! ```text
...
const USAGE: &str = "Usage: papyrus-lint <path-to-achlist>\n\n\
...
/// error.
fn run(args: &[String], stdout: &mut impl Write, stderr: &mut impl Write) -> u8 {
