...
// message, matching the CLI's plain-text report (see format_diagnostic_line).
// A finding with no rule id (typical of a test fixture) is labelled
// `(unknown)`, the same fallback the text export uses.
