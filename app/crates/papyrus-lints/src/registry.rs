...
//! matching [`crate::config::Rules`] field + default, a README row, and a
//! `docs/rules.json` entry. [`KNOWN_RULE_IDS`] / [`FIXABLE_RULE_IDS`] are
//! generated by `build.rs` from `docs/rules.json`, which is the single
//! source of truth for a rule's id/tags/severity/fixability/doc_slug —
//! see "Docs sync" in AGENTS.md.
