...
semicolons, indentation, whitespace around member-access dots, and spacing
around logical/comparison operators. The desktop app, standalone CLI, and
editor extensions all use the same lint and repair engine.
